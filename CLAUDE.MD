...
6. **Result displayed**, clipboard snapshotted, text set, pasted with Shift+Insert via `pyautogui`, clipboard restored
...
- `pyautogui` — Auto-paste (Shift+Insert); the clipboard itself is ctypes, in `clipboard.py`
